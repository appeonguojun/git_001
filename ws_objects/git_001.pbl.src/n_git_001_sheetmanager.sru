$PBExportHeader$n_git_001_sheetmanager.sru
$PBExportComments$Generated MDI Sheet Management
forward
global type n_git_001_sheetmanager from nonvisualobject
end type
end forward

global type n_git_001_sheetmanager from nonvisualobject
end type
global n_git_001_sheetmanager n_git_001_sheetmanager

type variables
string is_sheets[], is_display[]
w_git_001_basesheet iw_opensheets[]
menu im_items[]
end variables
...
public function long of_sheetisclosing (readonly w_git_001_basesheet aw_sheet)
...
li_rc = OpenSheet ( lw_sheet, as_sheetname, w_git_001_frame, 0, Cascaded! ) 
...
w_git_001_basesheet lw_sheets[], lw_init[]
...
lm_menu = w_git_001_frame.MenuId
...
w_git_001_sheet1	lw_sheet1
w_git_001_sheet2	lw_sheet2
w_git_001_sheet3	lw_sheet3
...
on n_git_001_sheetmanager.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_git_001_sheetmanager.destroy
