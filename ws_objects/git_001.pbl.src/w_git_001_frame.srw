$PBExportHeader$w_git_001_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_git_001_frame from window
end type
type mdi_1 from mdiclient within w_git_001_frame
end type
end forward
...
string title = "Frame"
string menuname = "m_git_001_frame"
...
global w_git_001_frame w_git_001_frame

type variables
n_git_001_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_git_001_basesheet aw_sheet)
public function long of_classcount (readonly w_git_001_basesheet aw_sheet)
public function integer of_adjustmenu (ref m_git_001_frame am_menu)
end prototypes
...
string ls_sheets[]  = { "w_git_001_sheet1", "w_git_001_sheet2", "w_git_001_sheet3" }
...
inv_sheetmgt = Create n_git_001_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_git_001_frame.create
if this.MenuName = "m_git_001_frame" then this.MenuID = create m_git_001_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_git_001_frame.destroy
